...
// grafico pizza - totens
const dadosTotens = [20, 80]; 
const labelsTotens = ['Totens reiniciados', 'Totens que não foram reiniciados'];
const coresTotens = ['#679BC5', '#0d4a7c']; 

const ctxTotens = document.getElementById('graficoPizzaTotens');

const chartTotens = new Chart(ctxTotens, {
    type: 'pie',
    data: {
        labels: labelsTotens,
        datasets: [{
            data: dadosTotens,
            backgroundColor: coresTotens
        }]
    },
    options: {
        plugins: {
